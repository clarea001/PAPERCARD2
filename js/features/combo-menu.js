...
function renderComboMenu() {
    ...
    tabBar.innerHTML = `
        ...
        <button class="combo-tab" data-tab="fast-tap" style="flex:1; padding:8px; border:none; background:var(--secondary-bg); color:var(--text-primary); border-radius:8px; cursor:pointer;">
            ⚡ 快捷输入
        </button>
    `;
